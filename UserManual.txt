...
Creating a new project is very simple, once you run the App, you choose the the first option on the Menu (1). The App will ask you to specify a Title for your new Project, which has to be unique, and a due date.
